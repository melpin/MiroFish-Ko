          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">보고서 생성 에이전트의 빠른 대화 버전입니다. 4가지 전문 도구를 호출할 수 있으며 MiroFish 전체 메모리를 활용합니다.</div>
              </div>
...
/* Left Panel - Report Style (Step4Report.vue와 동일한 스타일) */
.left-panel.report-style {
  width: 45%;
  min-width: 450px;
  background: #FFFFFF;
...
/* ordered list 번호 보정 - CSS 카운터로 여러 ol 번호를 연속 유지 */
.message-text {
